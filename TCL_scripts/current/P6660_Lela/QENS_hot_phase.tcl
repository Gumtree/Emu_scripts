...
hset /instrument/chpr/background/reqphase -64
wait 10

# acquisition 1 blocks of 1 hour at 6K

samplename empty_298K_-64
for {set idx0 0} {$idx0 < 1} {incr idx0} {
	broadcast loop $idx0 empty_298K_-64
	histmem start block
...
hset /instrument/chpr/background/reqphase -68
wait 10

# acquisition 1 blocks of 1 hour at 298K

samplename empty_298K_-68
for {set idx0 0} {$idx0 < 1} {incr idx0} {
	broadcast loop $idx0 empty_298K_-68
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}

hset /instrument/chpr/background/reqphase -72
wait 10

# acquisition 1 blocks of 1 hour at 6K

samplename empty_298K_-72
for {set idx0 0} {$idx0 < 1} {incr idx0} {
	broadcast loop $idx0 empty_298K_-72
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}

hset /instrument/chpr/background/reqphase -76
wait 10

# acquisition 1 blocks of 1 hour at 6K

samplename empty_298K_-76
for {set idx0 0} {$idx0 < 1} {incr idx0} {
	broadcast loop $idx0 empty_298K_-76
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
