...
# acquisition 14 blocks of 1 hour at 298K

samplename PT_D2Oexcess_298K_Andrew_newBeautifulShield
for {set idx0 0} {$idx0 < 14} {incr idx0} {
	broadcast loop $idx0 PT_D2Oexcess_298K_Andrew_newBeautifulShield
	histmem start block
