...
#Temperature
drive tc1_driveable 325 tc1_driveable3 325
wait 300
...
samplename sample_325K 
for {set idx0 0} {$idx0 < 18} {incr idx0} {
	broadcast loop $idx0 sample_325K  
	histmem start block
...
samplename sample_1_300K 
for {set idx0 0} {$idx0 < 18} {incr idx0} {
	broadcast loop $idx0 sample_300K  
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
