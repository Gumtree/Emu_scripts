...
samplename PFFpolymer-50Kto423K_el
...
wait 1
hset /sample/tc1/sensor/setpoint3 423
wait 1

runscan dummy_motor 10 14 385 time 60 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
