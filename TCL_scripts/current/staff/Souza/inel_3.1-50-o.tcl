...
wait 1
hset /instrument/doppler/ctrl/profile_selector/settings/amplitude 50
wait 1
hset /instrument/doppler/ctrl/profile_selector/settings/velocity 3.1
wait 1
# chopper and Doppler histogram configuration 
# (1:1 mode only) set_chopper_config_with_roi 9.962 40.42 1 1000 0 50 0 255 0 999
set_chopper_config_with_roi 9.870 20.21 1 1000 0 50 0 255 0 999
#wait 2
...
samplename Vcyl-30_inel


hset /instrument/doppler/ctrl/profile_selector/settings/offset -24.5
wait 1
