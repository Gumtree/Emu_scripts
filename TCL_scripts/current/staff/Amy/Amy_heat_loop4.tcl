...
for {set idx0 0} {$idx0 <3} {incr idx0} {
	...
	drive tc1_driveable [expr $idx0*50+50] tc1_driveable2 [expr $idx0*50+50] tc1_driveable3 [expr $idx0*50+50]
	wait 3600
}
...
for {set idx0 0} {$idx0 <5} {incr idx0} {
	...
	drive tc1_driveable [expr $idx0*25+175] tc1_driveable2 [expr $idx0*25+175] tc1_driveable3 [expr $idx0*25+175] 
	wait 3600
}
...
for {set idx0 0} {$idx0 <10} {incr idx0} {
	...
	drive tc1_driveable [expr $idx0*5+280] tc1_driveable2 [expr $idx0*5+280] tc1_driveable3 [expr $idx0*5+280] 
	wait 3600
}
