...
samplename YP_H2O_NEM_0.1_EFW_heating
...
runscan dummy_motor 10 14 89 time 90 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
...
samplename YP_H2O_NEM_0.1_363K_EFW
...
# Acquisition 
samplename YP_H2O_NEM_0.1_363K
for {set idx0 0} {$idx0 < 1} {incr idx0} {
	broadcast loop $idx0  YP_H2O_NEM_0.1_363K
	histmem start block
