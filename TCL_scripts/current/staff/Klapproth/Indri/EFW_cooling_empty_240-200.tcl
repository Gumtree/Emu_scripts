...
hset /sample/tc3/sensor/setpoint3 180
wait 1
hset /sample/tc3/sensor/setpoint1 200
wait 1

runscan dummy_motor 10 14 16 time 300 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
