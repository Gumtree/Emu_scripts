...
# NUM_ACQS = number of acquisitions in the sequence (number of EFW and IFW)
# NUM_SEQ = number of sequences to collect over (number of counting steps per EFW and IFW)
...
# ramp for VTI
hset /sample/tc3/control/ramp_loop_3 1,0.2
wait 1
...
for {set n 0} {$n < $TOTAL_NUM_ACQS} {incr n $NUM_ACQS} {
	...
	# IFW1
	doppler ctrl/profile_selector/settings/velocity 1.5
...
# ramp for VTI
hset /sample/tc3/control/ramp_loop_3 0,0.2
wait 1
