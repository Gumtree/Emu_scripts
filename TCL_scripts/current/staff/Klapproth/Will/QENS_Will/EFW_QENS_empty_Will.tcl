...
samplename empty_gas_loading_EFW_300K
runscan dummy_motor 10 14 15 time 240 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T }
...
samplename empty_gas_loading_300K
for {set idx0 0} {$idx0 < 12} {incr idx0} {
	broadcast loop $idx0  empty_gas_loading_300K
	histmem start block
...
samplename empty_gas_loading_EFW_250K
runscan dummy_motor 10 14 15 time 240 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T }
