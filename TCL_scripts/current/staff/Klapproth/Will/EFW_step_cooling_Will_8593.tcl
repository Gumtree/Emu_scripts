...
drive tc1_temp0_setpoint 295 tc3_driveable 350
#wait 120
...
samplename Ca-Mt_5M-CaCl2-D2O_cooling_350-300K
newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
for {set idx0 0} {$idx0 < 51} {incr idx0} {
	
		broadcast Target temperature = [expr $idx0*(-1)+350]
		#drive tc1_temp0_setpoint [expr $idx0*(-1)+295]
		drive tc3_driveable [expr $idx0*(-1)+350]
		wait 60
