...
#drive tc1_temp0_setpoint 200 tc3_driveable2 200
hset /sample/tc1/pres3/setpoint 8

#wait 360
drive tc1_temp0_setpoint 240 tc3_driveable2 240
wait 600
...
runscan dummy_motor 10 14 40 time 180 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
