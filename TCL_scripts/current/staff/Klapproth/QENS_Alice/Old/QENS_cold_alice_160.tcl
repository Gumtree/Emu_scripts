...
# Acquisition 
samplename TBAB_high_CO2_3_160K
for {set idx0 0} {$idx0 < 12} {incr idx0} {
	broadcast loop $idx0 TBAB_high_CO2_3_160K 
	histmem start block
...
# Acquisition 
samplename TBAB_high_CO2_3_193K
for {set idx0 0} {$idx0 < 12} {incr idx0} {
	broadcast loop $idx0 TBAB_high_CO2_3_193K 
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
...
# Acquisition 
samplename TBAB_high_CO2_3_230K
for {set idx0 0} {$idx0 < 12} {incr idx0} {
	broadcast loop $idx0 TBAB_high_CO2_3_230K 
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
