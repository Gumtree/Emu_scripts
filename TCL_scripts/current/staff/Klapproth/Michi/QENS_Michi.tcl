...
# Acquisition 16 blocks of 1 hour at 1p6K
samplename Empty_308K
for {set idx0 0} {$idx0 < 12} {incr idx0} {
	broadcast loop $idx0 Empty_308K
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
###################################################################
#drive tc3_driveable3 300 tc3_driveable 328