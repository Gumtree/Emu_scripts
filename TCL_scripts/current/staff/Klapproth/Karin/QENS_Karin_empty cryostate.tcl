...
#samplename inner_ref
#for {set idx0 0} {$idx0 < 30 } {incr idx0} {
	#broadcast loop $idx0   inner_ref
	#histmem start block
...
#acquisition of 20 x 0.5 hour blocks 
samplename empty_cryostate_hot_stick_300K
for {set idx0 0} {$idx0 < 250 } {incr idx0} {
	broadcast loop $idx0   empty_cryostate_hot_stick_300K
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
...
#acquisition of 20 x 0.5 hour blocks 
#samplename outer_350K
#for {set idx0 0} {$idx0 < 25 } {incr idx0} {
 #      broadcast loop $idx0   outer_350K
  #     histmem start block
   #    newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
    #   save 
#}