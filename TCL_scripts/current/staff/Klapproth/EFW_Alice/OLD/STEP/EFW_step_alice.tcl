...
samplename empty_0p5_gap_160-230K
newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
for {set idx0 0} {$idx0 < 36} {incr idx0} {
	
		broadcast Target temperature = [expr $idx0*(2)+160]
	
		drive tc1_temp0_setpoint [expr $idx0*(2)+155] 
		drive tc3_driveable2 [expr $idx0*(2)+160]
