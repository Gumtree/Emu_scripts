...
samplename TBAB_low_CO2_2_EFW_test_initial_160K
newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
for {set idx0 0} {$idx0 < 10} {incr idx0} {
	
		broadcast Target temperature = [expr $idx0*(0)+193.5]
	
		drive tc1_temp0_setpoint [expr $idx0*(0)+188.5] tc3_driveable2 [expr $idx0*(0)+193.5]
