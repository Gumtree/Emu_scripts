...
# Temperature: start
drive tc1_temp0_setpoint 255 tc3_driveable2 230
wait 240
...
samplename TBAB_low_CO2_2_EFW_test_230K_initial
newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
for {set idx0 0} {$idx0 < 10} {incr idx0} {
	
		broadcast Target temperature = [expr $idx0*(0)+230]
	
		drive tc1_temp0_setpoint [expr $idx0*(0)+255] tc3_driveable2 [expr $idx0*(0)+230]
...
# Acquisition   
samplename TBAB_low_CO2_2_230K
for {set idx0 0} {$idx0 < 12} {incr idx0} {
	broadcast loop $idx0 TBAB_low_CO2_2_230K 
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
...
samplename TBAB_low_CO2_2_EFW_test_230K_final
newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
for {set idx0 0} {$idx0 < 10} {incr idx0} {
