...
drive tc3_driveable3 298 tc3_driveable 318
drive tc3_driveable 323
#wait 600

# Acquisition 16 blocks of 1 hour at 1p6K
samplename DMO_25H2O_323K
for {set idx0 0} {$idx0 < 24} {incr idx0} {
	broadcast loop $idx0 DMO_25H2O_323K
	histmem start block
...
drive tc3_driveable 353
#drive tc1_pres7_setpoint 5 
wait 600

# Acquisition 16 blocks of 1 hour at 1p6K
samplename DMO_25H2O_353K
for {set idx0 0} {$idx0 < 24} {incr idx0} {
	broadcast loop $idx0 DMO_25H2O_353K
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
