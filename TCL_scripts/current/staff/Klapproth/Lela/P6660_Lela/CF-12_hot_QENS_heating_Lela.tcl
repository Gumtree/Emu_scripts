...
#QENS acquisition 20 blocks of 1 hour heating 298K

samplename PT2_D2Oexcess_heating_newBeautifulShield_down
for {set idx0 0} {$idx0 < 20} {incr idx0} {
	broadcast loop $idx0 PT2_D2Oexcess_heating_newBeautifulShield_down
	histmem start block
