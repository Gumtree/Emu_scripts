...
samplename NCC5_80mM_298K

for {set idx0 0} {$idx0 < 20} {incr idx0} {
	broadcast loop $idx0  NCC5_80mM_298K
	histmem start block
...
runscan dummy_motor 10 14 44 time 90 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
...
samplename NCC5_80mM_363K

for {set idx0 0} {$idx0 < 20} {incr idx0} {
	broadcast loop $idx0  NCC5_80mM_363K
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
