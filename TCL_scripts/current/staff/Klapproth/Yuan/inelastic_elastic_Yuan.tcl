...
samplename 20%PPIB2_0.5mm_gap_298K

for {set idx0 0} {$idx0 < 18} {incr idx0} {
	broadcast loop $idx0  20%PPIB2_0.5mm_gap_298K
	histmem start block
...
samplename 20%PPIB2_0.5mm_ga  p_298K_EFW
...
wait 1
hset /sample/tc3/sensor/setpoint1 333
hset /sample/tc3/sensor/setpoint3 300
wait 1


runscan dummy_motor 10 14 24 time 90 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
...
samplename 20%PPIB2_0.5mm_gap_333K

for {set idx0 0} {$idx0 < 20} {incr idx0} {
	broadcast loop $idx0  20%PPIB2_0.5mm_gap_333K
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
...
samplename 20%PPIB2_0.5mm_gap_363K_EFW
...
samplename 20%PPIB2_0.5mm_gap_363K

for {set idx0 0} {$idx0 < 20} {incr idx0} {
	broadcast loop $idx0  20%PPIB2_0.5mm_gap_363K
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
}
