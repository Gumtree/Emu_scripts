...
# Sample:D2O_C3H8, 1mm gap, annular cell
...
# acquisition 5 blocks of 1 hour at 90K

samplename D2O_C3H8_90K
...
# acquisition 5 blocks of 1 hour at 50K

samplename D2O_C3H8_50K
for {set idx0 0} {$idx0 < 5} {incr idx0} {
	broadcast loop $idx0
	broadcast [tc1_temp0_setpoint] [tc2_temp6_setpoint]
	histmem start block
...
# acquisition 5 blocks of 1 hour at 35K

samplename D2O_C3H8_35K
