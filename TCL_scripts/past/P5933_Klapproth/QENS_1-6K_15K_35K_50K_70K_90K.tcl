...
# acquisition 2 blocks of 1 hour at 1.61K

samplename H2O_C2H6__grey_1-6K
...
################################################################################
drive tc2_temp6_setpoint 15
wait 900 

# acquisition 2 blocks of 1 hour at 15K

samplename H2O_C2D6_grey_15K
for {set idx0 0} {$idx0 < 2} {incr idx0} {
	broadcast loop $idx0
	broadcast [tc1_temp0_setpoint] [tc2_temp6_setpoint]
	histmem start block
...
# acquisition 2 blocks of 1 hour at 35K

samplename H2O_C2D6_35K
for {set idx0 0} {$idx0 < 2} {incr idx0} {
	broadcast loop $idx0
	broadcast [tc1_temp0_setpoint] [tc2_temp6_setpoint]
	histmem start block
...
###################################################################################################
#hset /sample/tc1/temp0/setpoint 40 

drive tc2_temp6_setpoint 50
wait 900 

# acquisition 2 blocks of 1 hour at 50K

samplename H2O_C2D6_50K
for {set idx0 0} {$idx0 < 2} {incr idx0} {
	broadcast loop $idx0
	broadcast [tc1_temp0_setpoint] [tc2_temp6_setpoint]
	histmem start block
...
# acquisition 2 blocks of 1 hour at 70K

samplename H2O_C2D6_70K
for {set idx0 0} {$idx0 < 2} {incr idx0} {
	broadcast loop $idx0
	broadcast [tc1_temp0_setpoint] [tc2_temp6_setpoint]
	histmem start block
...
# acquisition 2 blocks of 1 hour at 90K

samplename H2O_C2D6_90K
for {set idx0 0} {$idx0 < 2} {incr idx0} {
	broadcast loop $idx0
	broadcast [tc1_temp0_setpoint] [tc2_temp6_setpoint]
	histmem start block
