...
samplename TrzH2PO4-baseTto370K_el
...
wait 1
hset /sample/tc1/sensor/setpoint3 370
wait 1

runscan dummy_motor 10 14 380 time 60 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
...
wait 1
hset /sample/tc1/sensor/setpoint3 303
wait 1
