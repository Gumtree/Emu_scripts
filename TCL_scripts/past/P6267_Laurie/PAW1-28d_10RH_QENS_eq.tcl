...
# Sample:PAW1_28d_10RH_300K, 3mm gap, annular cell,gas loading stick (like cold stick)
...
samplename PAW1_28d_10RH_300K_eq
for {set idx0 0} {$idx0 < 16} {incr idx0} {
	broadcast loop $idx0 PAW1_28d_10RH_300K_eq 
	histmem start block
