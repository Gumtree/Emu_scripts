...
# Sample:Li15PSCl3, 0.5mm gap, annular cell
...
samplename Li15PSCl3_100K
for {set idx0 0} {$idx0 < 10} {incr idx0} {
	broadcast loop $idx0 Li15PSCl3_100K
	broadcast temperature tc2_sensor0
	histmem start block
...
samplename Li15PSCl3_200K
for {set idx0 0} {$idx0 < 10} {incr idx0} {
	broadcast loop $idx0 Li15PSCl3_200K
	broadcast temperature tc2_sensor0
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
...
samplename Li15PSCl3_300K
for {set idx0 0} {$idx0 < 10} {incr idx0} {
	broadcast loop $idx0 Li15PSCl3_300K
	broadcast temperature tc2_sensor0
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
...
samplename Li15PSCl3_400K
for {set idx0 0} {$idx0 < 10} {incr idx0} {
	broadcast loop $idx0 Li15PSCl3_400K
	broadcast temperature tc2_sensor0
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
...
samplename Li15PSCl3_500K
for {set idx0 0} {$idx0 < 10} {incr idx0} {
	broadcast loop $idx0 Li15PSCl3_500K
	broadcast temperature tc2_sensor0
	histmem start block
	newfile TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX RAW_TOTAL_HISTOGRAM_YTAUX
	save 
