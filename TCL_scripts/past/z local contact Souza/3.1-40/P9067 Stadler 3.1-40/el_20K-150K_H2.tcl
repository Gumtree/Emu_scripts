...
samplename DCOR+D2O-20Kto150K_el
...
wait 1
hset /sample/tc3/control/ramp_loop_2 1,0.1
wait 1
hset /sample/tc3/sensor/setpoint2 150
wait 1
# ramp for H2
...
runscan dummy_motor 10 14 1300 time 60 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
