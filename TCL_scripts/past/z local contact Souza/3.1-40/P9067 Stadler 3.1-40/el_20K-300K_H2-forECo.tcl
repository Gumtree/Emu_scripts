...
wait 1
hset /sample/tc3/control/ramp_loop_2 1,0.2
wait 1
...
runscan dummy_motor 10 14 1400 time 60 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
