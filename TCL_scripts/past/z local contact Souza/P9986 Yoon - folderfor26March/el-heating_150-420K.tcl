...
samplename Zn-aip-bpy-dry_el_heating-150-to-420K
...
wait 1
hset /sample/tc3/sensor/setpoint1 420
wait 1

runscan dummy_motor 10 14 280 time 60 datatype { TOTAL_HISTOGRAM_XT TOTAL_HISTOGRAM_T RAW_TOTAL_HISTOGRAM_XTAUX }
